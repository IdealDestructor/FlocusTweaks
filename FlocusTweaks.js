...
(function () {
  ...
  $(window).load(function () {
    ...
    if (getConfigOptions().option1) {
      ...
      $("#top-left").html(`
        <div style="font-size:48px;font-family:cursive;color:white">Francis</div>
    `);
    }
    ...
    function updateDisplayName(newName) {
      var nameToChange =
        GM_getValue("displayname") || localStorage.getItem("flocus-name");
      ...
      $(".greeting").text(function (index, text) {
        ...
        var modifiedText = text
          .replace(
            new RegExp(localStorage.getItem("flocus-name"), "g"),
            newName
          )
    ...
    // Welcome message
    console.log(
      `%cFlocus Tweaks v${scriptVersion} 🚀`,
